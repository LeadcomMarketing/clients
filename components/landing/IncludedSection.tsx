  ...
  return (
    <section className="py-16 md:py-24" style={{ backgroundColor: "var(--secondary)" }}>
      <div className="max-w-5xl mx-auto px-5 md:px-8">
        ...
        <p className="text-center text-xl md:text-lg mb-14 max-w-md mx-auto" style={{ color: "var(--muted-foreground, #6B6460)" }}>
                ...
                <div key={i} className="relative flex gap-3 sm:gap-5 items-start bg-white rounded-[1.5rem] p-4 sm:p-5 md:p-6 shadow-[0_4px_24px_rgba(0,0,0,0.07)] border hover:shadow-[0_8px_32px_rgba(0,0,0,0.12)] transition-shadow duration-200" style={{ borderColor: "var(--border, #E5E0D9)" }}>
                  ...
                  <div className="flex flex-col justify-center flex-1">
                    <div className="flex items-center gap-2 mb-1 flex-wrap">
                      ...
                      <p className="font-bold text-xl md:text-lg leading-snug" style={{ color: "var(--foreground, #1A1714)" }}>
                        {item.title}
                      </p>
                      {item.value && (
                    ...
                    <p className="text-xl md:text-base leading-relaxed" style={{ color: "var(--muted-foreground, #6B6460)" }}>{item.description}</p>
                  </div>
                </div>
              )
            })}
